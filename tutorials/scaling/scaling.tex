...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: austin\\\#\# Loading required package: numDeriv}}\end{kframe}
=======
\begin{alltt}
\hlstd{docMat[}\hlnum{1}\hlopt{:}\hlnum{5}\hlstd{,} \hlnum{1}\hlopt{:}\hlnum{5}\hlstd{]}
\end{alltt}
\begin{verbatim}
##                                        a abandoned abandoning abetted ability
