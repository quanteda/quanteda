...
#' textplot_wordcloud2(mydfm)
#' 
#' # plot in colors with some additional options passed to wordcloud
#' textplot_wordcloud2(mydfm, random.color = TRUE, rot.per = .25, 
...
#' textplot_wordcloud2(dfm_tfidf(govtoppDfm), comparison = TRUE)
#' # compare to non-tf-idf version
#' textplot_wordcloud2(govtoppDfm, comparison = TRUE)
#' }
#' @export
#' @keywords textplot
textplot_wordcloud2 <- function(x, comparison = FALSE, ...) {
    UseMethod("textplot_wordcloud2")
}

#' @export
textplot_wordcloud2.default <- function(x, comparison = FALSE, ...) {
    stop(friendly_class_undefined_message(class(x), "textplot_wordcloud2"))
}

#' @export
textplot_wordcloud2.dfm <- function(x, comparison = FALSE, ...) {
...
#' @export
textplot_wordcloud2.tokens <- function(x, comparison = FALSE, ...) {
    textplot_wordcloud2(dfm(x, verbose = FALSE), comparison = comparison, ...)
}
