...
#'   including whitespace where applicable; except for `tokenize_word1()`, which
...
#' @param version integer; if 1, behave the same as pre-v2 "word" (meaning
...
preserve_special <- function(x, split_hyphens, split_tags, verbose) {
    if (!split_hyphens) {
