...
#' (dfmat1 <- dfm(c(doc1 = "This is one sample text sample."), verbose = FALSE))
#' (dfmat2 <- dfm(c(doc2 = "One two three text text."), verbose = FALSE))
#' (dfmat3 <- dfm(c(doc3 = "This is the fourth sample text."), verbose = FALSE))
#' rbind(dfmat1, dfmat2)
