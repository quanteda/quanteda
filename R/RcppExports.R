...
qatd_cpp_similarity_linear <- function(mt, method, target_, rank, limit = -1.0, weight = 1.0, condition_ = FALSE) {
    .Call(`_quanteda_qatd_cpp_similarity_linear`, mt, method, target_, rank, limit, weight, condition_)
}
