...
qatd_cpp_tokens_lookup <- function(texts_, types_, keys_, ids_, overlap, padding) {
    .Call(`_quanteda_qatd_cpp_tokens_lookup`, texts_, types_, keys_, ids_, overlap, padding)
}
