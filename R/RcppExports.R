...
qatd_cpp_tokens_restore <- function(texts_, markers_left_, markers_right_, types_, delim_) {
    .Call(`_quanteda_qatd_cpp_tokens_restore`, texts_, markers_left_, markers_right_, types_, delim_)
}
