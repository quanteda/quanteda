...
qatd_cpp_tokens_contexts <- function(texts_, types_, words_, window, remove, overlap) {
    .Call('quanteda_qatd_cpp_tokens_contexts', PACKAGE = 'quanteda', texts_, types_, words_, window, remove, overlap)
}
