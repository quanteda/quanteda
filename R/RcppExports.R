...
qatd_cpp_fcm <- function(texts_, n_types, count, window, weights_, ordered, tri, nvec) {
    .Call(`_quanteda_qatd_cpp_fcm`, texts_, n_types, count, window, weights_, ordered, tri, nvec)
}
