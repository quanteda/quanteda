...
qatd_cpp_fcm <- function(xptr, n_types, weights_, boolean, ordered) {
    .Call(`_quanteda_qatd_cpp_fcm`, xptr, n_types, weights_, boolean, ordered)
}

qatd_cpp_index <- function(xptr, words_) {
    .Call(`_quanteda_qatd_cpp_index`, xptr, words_)
}
