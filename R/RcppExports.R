...
qatd_cpp_sequences2 <- function(texts_, types_, count_min, len_max, method, nested) {
    .Call('quanteda_qatd_cpp_sequences2', PACKAGE = 'quanteda', texts_, types_, count_min, len_max, method, nested)
}
