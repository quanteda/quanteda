...
qatd_cpp_sequences <- function(texts_, types_, count_min, len_min, len_max, method, smoothing, nested) {
    .Call('quanteda_qatd_cpp_sequences', PACKAGE = 'quanteda', texts_, types_, count_min, len_min, len_max, method, smoothing, nested)
}
