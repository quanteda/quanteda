...
wordfish_cpp <- function(wfm, dirvec, priorvec, tolvec, disptype, dispmin, svd_sparse, residual_floor) {
    .Call('quanteda_wordfish_cpp', PACKAGE = 'quanteda', wfm, dirvec, priorvec, tolvec, disptype, dispmin, svd_sparse, residual_floor)
}
