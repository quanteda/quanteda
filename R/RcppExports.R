...
cpp_dfm <- function(xptr, padding = TRUE) {
    .Call(`_quanteda_cpp_dfm`, xptr, padding)
}

cpp_as_matrix <- function(xptr, length, extract_, asis = TRUE) {
    .Call(`_quanteda_cpp_as_matrix`, xptr, length, extract_, asis)
}

cpp_fcm <- function(xptr, weights_, boolean, ordered, thread = -1L) {
    .Call(`_quanteda_cpp_fcm`, xptr, weights_, boolean, ordered, thread)
}
...
cpp_get_types <- function(xptr) {
    .Call(`_quanteda_cpp_get_types`, xptr)
}

cpp_count_types <- function(xptr) {
    .Call(`_quanteda_cpp_count_types`, xptr)
}
