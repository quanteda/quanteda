...
qutd_cpp_ca <- function(objm, threads, residual_floor) {
...
qatd_cpp_sequences <- function(texts_, types_, words_ignore_, count_min, sizes_, method, smoothing, nested) {
    .Call(`_quanteda_qatd_cpp_sequences`, texts_, types_, words_ignore_, count_min, sizes_, method, smoothing, nested)
}
