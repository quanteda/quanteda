...
#' textplot_wordcloudold(mydfm)
#' 
#' # plot in colors with some additional options passed to wordcloud
#' textplot_wordcloudold(mydfm, random.color = TRUE, rot.per = .25, 
...
#' textplot_wordcloudold(dfm_tfidf(govtoppDfm), comparison = TRUE)
#' # compare to non-tf-idf version
#' textplot_wordcloudold(govtoppDfm, comparison = TRUE)
#' }
#' @export
#' @keywords textplot
textplot_wordcloudold <- function(x, comparison = FALSE, ...) {
    UseMethod("textplot_wordcloudold")
}

#' @export
textplot_wordcloudold.default <- function(x, comparison = FALSE, ...) {
    stop(friendly_class_undefined_message(class(x), "textplot_wordcloudold"))
}
...
#' @export
textplot_wordcloudold.tokens <- function(x, comparison = FALSE, ...) {
    textplot_wordcloudold(dfm(x, verbose = FALSE), comparison = comparison, ...)
}
