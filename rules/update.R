...
data_breakrules_word <- list(word = paste0(readLines("rules/word.txt"), collapse = "\n"))
...
data_breakrules_sentence <- list(sentence = paste0(readLines("rules/sent.txt"), collapse = "\n"))
