...
//typedef tbb::concurrent_vector<Config> Configs;
...
// #endif
    ...
    //         if (value_.size() <= (int)j)
    //             throw std::range_error("Invalid length");
...
#cpp_index_types("whale*", type, TRUE, 1)
