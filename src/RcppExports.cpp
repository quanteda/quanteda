...
S4 qatd_cpp_similarity_linear(const arma::sp_mat& mt, const int method, const IntegerVector target_, unsigned int rank, double limit, const double weight, bool condition_);
RcppExport SEXP _quanteda_qatd_cpp_similarity_linear(SEXP mtSEXP, SEXP methodSEXP, SEXP target_SEXP, SEXP rankSEXP, SEXP limitSEXP, SEXP weightSEXP, SEXP condition_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(qatd_cpp_similarity_linear(mt, method, target_, rank, limit, weight, condition_));
    return rcpp_result_gen;
END_RCPP
}
// qatd_cpp_similarity
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_quanteda_qatd_cpp_similarity_linear", (DL_FUNC) &_quanteda_qatd_cpp_similarity_linear, 7},
