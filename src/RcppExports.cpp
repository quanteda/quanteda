...
// qatd_cpp_sequences2
DataFrame qatd_cpp_sequences2(const List& texts_, const CharacterVector& types_, const unsigned int count_min, unsigned int len_max, const String& method, bool nested);
RcppExport SEXP quanteda_qatd_cpp_sequences2(SEXP texts_SEXP, SEXP types_SEXP, SEXP count_minSEXP, SEXP len_maxSEXP, SEXP methodSEXP, SEXP nestedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const List& >::type texts_(texts_SEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type nested(nestedSEXP);
    rcpp_result_gen = Rcpp::wrap(qatd_cpp_sequences2(texts_, types_, count_min, len_max, method, nested));
    return rcpp_result_gen;
END_RCPP
}
