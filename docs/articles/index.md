...
- [Performance
  improvements](https://quanteda.io/articles/pkgdown/benchmarks_xptr.md):
- [Example: Chinese text
  analysis](https://quanteda.io/articles/pkgdown/examples/chinese.md):
- [The Structure of
  quanteda](https://quanteda.io/articles/pkgdown/design.md):
- [Replication: Text Analysis with R for Students of
  Literature](https://quanteda.io/articles/pkgdown/replication/digital-humanities.md):
- [事例:
...
- [Example: Latent Semantic Analysis
  (LSA)](https://quanteda.io/articles/pkgdown/examples/lsa.md):
- [Example: Convolutional Neural
  Network](https://quanteda.io/articles/pkgdown/examples/neural-networks.md):
- [Parallel
  computing](https://quanteda.io/articles/pkgdown/parallelisation.md):
- [Working with multi-word
  expressions](https://quanteda.io/articles/pkgdown/phrase.md):
...
- [Quickstart: Further
  Examples](https://quanteda.io/articles/pkgdown/quickstart_further_examples.md):
- [क्विक आरंभ
...
- [External pointer-based tokens
  objects](https://quanteda.io/articles/pkgdown/tokens_xptr.md):
- [Example: Social media analysis (X formerly
