...
- During installation, ensure you select the option to add RTools to the
  system path.
...
To open the terminal on macOS, press `Cmd+Space` to open Spotlight, type
“Terminal”, and press enter. Alternatively, you can find the Terminal in
...
To open the terminal in Linux, you can usually use `Ctrl+Alt+T`, or
search for “Terminal” in your system’s application launcher.
...
After setting up the required tools and libraries, install **quanteda**
from CRAN:
...
Parallelisation functions properly if you receive a message detailing
the number of threads used for parallel computing after loading
**quanteda**.
