...
*  [**spacyr**](https://github.com/quanteda/spacyr): NLP usando la librería [spaCy](http://spacy.io), incluyendo etiquetado part-of-speech, entity recognition y dependency parsing.
...
set.seed(100)
textplot_wordcloud(mydfm, min_freq = 6, 
                   random_order = FALSE,
                   rotation = .25, 
