...
###Read the corpus from the [**text2vec** vignette](http://text2vec.org/glove.html):
```{r eval = TRUE}
...
## The Glove model leans two sets of word vectors - main and context. According to Glove paper, averaging the two word vectors results in more accurate representation.
```{r}
