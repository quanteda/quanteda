...
An R package for managing and analyzing text.[^thanks]

[^thanks]: This research was supported by  European
    Research Council grant ERC-2011-StG 283794-QUANTESS, Principal Investigator
    Kenneth Benoit.  Core
    contributors to the project include Paul Nulty, Adam Obeng,
    Kohei Watanabe, Haiyan Wang, Ben Lauderdale, Will Lowe, and Pablo Barberà.
...
name of the character vector `data_char_inaugural`.  This works using our fixed starting and ending positions with
...
presDfm <- dfm(corpus_subset(data_corpus_inaugural, Year>1980), 
               ...
               stem = TRUE, verbose = FALSE, removePunct = TRUE)
