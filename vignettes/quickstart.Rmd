...
```{r}
summary(subset(data_corpus_inaugural, Year > 1990))
summary(subset(data_corpus_inaugural, President == "Adams"))
```
...
```{r}
myCorpus <- subset(data_corpus_inaugural, Year > 1990)
...
```{r}
recentCorpus <- subset(data_corpus_inaugural, Year > 1991)
```
...
```{r fig.width = 6}
presDfm <- dfm(subset(data_corpus_inaugural, Year>1980), 
