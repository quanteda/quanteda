...
if(require(RColorBrewer))
    plot(mydfm, max.words=100, colors = brewer.pal(6, "Dark2"), scale=c(5, .5))
```
...
```{r}
myDict <- dictionary(list(terror = c("terrorism", "terrorists", "threat","a"),
...
obamaDistance <- similarity(presDfm, c("2009-Obama" , "2013-Obama"), n=NULL, 
                            margin="documents", method="cosine")
dotchart(obamaDistance$`2009-Obama`, xlab="Cosine distance")
```
