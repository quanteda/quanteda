...
wiki_vector_dfm <- as.dfm(rbind(wiki_vectors, new_berlin))
cos_sim <-  textstat_simil(wiki_vector_dfm, wiki_vector_dfm[, "new_berlin"],
...
wiki_vector_dfm <- as.dfm(rbind(wiki_vectors, new_london))
cos_sim <-  textstat_simil(wiki_vector_dfm, wiki_vector_dfm[, "new_london"],
                           margin = "documents", method = "cosine")
head(sort(cos_sim[, 1], decreasing = TRUE), 5)
```
