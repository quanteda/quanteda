...
obama_simil <- textstat_simil(pres_dfm, selection = c("2009-Obama" , "2013-Obama"), 
...
我们也可查看特征相似度:
```{r}
sim <- textstat_simil(pres_dfm, selection = c("fair", "health", "terror"),
