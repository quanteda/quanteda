...
A detailed comparison of performance gains and execution times for `tokens` versus `tokens_xptr` objects is available in a [separate article](./articles/benchmark_xptr.html). 
...
We explore further benchmarks and comparisons for `tokens_xptr` usage in a [separate article](./articles/benchmark_xptr.html).
