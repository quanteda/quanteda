...
本ページは[Quic Start Guide](http://docs.quanteda.io/articles/pkgdown/quickstart.html)の日本語訳であり，英語のデータの分析を通じて**quanteda**の基本的な使い方を説明する．日本語のデータの分析法に関しては，以下のページを参照．

* [事例: 衆議院外務委員会の議事録](http://docs.quanteda.io/articles/pkgdown/examples/japanese.html)
* [事例: 2017年総選挙に関するツイート](http://docs.quanteda.io/articles/pkgdown/examples/japanese_twitter.html)
...
GitHubから最新の開発バージョンをインストールする方法については，https://github.com/kbenoit/quanteda を参照．
...
### コーパス内の文書の一部の文書の抽出 {#subsetting-corpus-objects}
...
[**quantedaData**](http://github.com/kbenoit/quantedaData)をインストールすることで，より多くのコーパスを試すことができる．
...
RStudioの"Environment"パネル，またはRの`View()`を用いることで，dfmに格納された値を見ることができる．dfmに対して`plot()`を用いると，[**wordcloud**](https://cran.r-project.org/web/packages/wordcloud)を使ってワードクラウドが表示される．
