...
```
注：以上这个指南翻译于英文版[quickstart](http://docs.quanteda.io/articles/pkgdown/quickstart.html)：版本号0.99.9023
...
head(ch_mw17, 10)
```
注：以上这部分介绍翻译于英文版[chinese](http://docs.quanteda.io/articles/pkgdown/examples/chinese.html)：版本号0.99.9023
