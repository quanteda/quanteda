...
=======
textfile <- "http://github.com/kbenoit/quanteda/texts/irishbudgets2010.zip"
download.file(textfile, basename(textfile), method="curl", extra="-L") # download this zipped archive of texts
unzip(basename(amicusFile)) # unzip the file
...
unzip(basename(textfile)) # unzip the file
attNames <- c("year", "debate", "number", "firstname", "surname", "party")
ieBudgets2010 <- corpusFromFilenames("budget_2010", 
                                     c("year", "debate", "no", "fname", "speaker", "party"), 
                                     sep="_")
>>>>>>> d04d5c940958195d1481feb630b8087f3c40530a
@
