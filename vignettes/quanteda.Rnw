...
#newAttribs <- data.frame(year="2000", debate="bud", no="99", fname="Joe", speaker="Bloggs", party="Green" )
...
<<eval=FALSE>>=
newAttrib <- c('gray','gray','blue', 'gray','gray','yellow','gray','gray','gray','gray','gray', 'gray','gray','gray', 'gray')
