...
On most platforms, this will be done automatically when you install quanteda, but will fail on OS X unless you 
have some additional tools installed.  

[See instructions on installing topicmodels on OS X Mavericks or Yosemite here.](http://www.kenbenoit.net/how-to-install-the-r-package-topicmodels-on-os-x/)

You will also need to install [Will Lowe's austin package](http://conjugateprior.org/software/austin/).  Just follow the instructions below.

```S
## devtools required to install quanteda from Github
if (!require(devtools)) install.packages("devtools")
## Will Lowe's austin package
if (!require(austin)) install.packages("austin", repos="http://r-forge.r-project.org", type="source")
