...
as the binary versions are not yet built for the latest versions of R (>= 3.1.1.).  

Mac: To install the topicmodels package,
*  you will need a C compiler installed.  For the Mac, you can get this by installing 
   [XCode Tools](https://macappsto.re/gb/Bk9QD.m)
   from the App Store.  (After installation, you need to open the App from the Applications folder 
   for it to complete installation.)
*  Install [homebrew](http://brew.sh) using
   ```
   ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install)"
   ```
*  Install the Gnu Scientific Library using `brew install gsl`
*  Download to your Downloads folder the source file http://cran.r-project.org/src/contrib/topicmodels_0.2-1.tar.gz from the [CRAN topicmodels page](http://cran.r-project.org/web/packages/topicmodels/index.html).
*  Open a Terminal window, and execute this command:
   ```
   R CMD INSTALL ~/Downloads/topicmodels_0.2-1.tar.gz
   ```
