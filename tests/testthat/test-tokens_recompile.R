...
test_that("keep gap and dupli argument works, #1278", {
    ...
    expect_equal(unclass(toks_pad2)[[1]], c(0, 1, 2, 2, 0))
    ...
    expect_equal(unclass(toks_pad3)[[1]], c(0, 1, 2, 3, 4))
    ...
    expect_equal(unclass(toks_pad4)[[1]], c(0, 2, 3, 3, 0))
    ...
    expect_equal(unclass(toks_pad5)[[1]], c(0, 2, 3, 4, 6))
