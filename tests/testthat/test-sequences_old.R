...
test_that("test that ordered argument is working", {
    ...
    seqs <- sequences_old(toks, "^([A-Z][a-z\\-]{2,})", valuetype="regex", case_insensitive = FALSE,
    ...
    seqs_ordered <- sequences_old(toks, "^([A-Z][a-z\\-]{2,})", valuetype="regex", case_insensitive = FALSE,
...
test_that("test that nested argument is working", {
    ...
    seqs_nested <- sequences_old(toks, "^[A-Z]$", valuetype="regex", case_insensitive = FALSE,
