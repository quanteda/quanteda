...
test_that("readability count is ok", {
    expect_equal(round(textstat_readability("The cat in the hat ate breakfast.", "Flesch")), 103)
    expect_equal(textstat_readability("The cat in the hat ate breakfast.", "FOG"), 2.8)
})