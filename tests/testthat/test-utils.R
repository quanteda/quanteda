...
test_that("message_select works as expected", {
    expect_message(
        quanteda.core:::message_select("remove", 10, 5, 0, 0),
        "removed 10 features"
    )
    expect_message(
        quanteda.core:::message_select("remove", 10, 5, 0, 0),
    ...
    expect_message(
        quanteda.core:::message_select("remove", 1, 5, 0, 0),
        "removed 1 feature"
    )
    expect_message(
        quanteda.core:::message_select("remove", 5, 1, 0, 0),
        " and 1 document$"
    )
    expect_message(
        quanteda.core:::message_select("remove", 0, 0, 0, 0),
        "removed 0 features$"
    )

    expect_message(
        quanteda.core:::message_select("select", 1000, 1000000, 0, 0),
    ...
    expect_message(
        quanteda.core:::message_select("remove", 10, 5, 2, 3),
        "2 features"
    )
    expect_message(
        quanteda.core:::message_select("remove", 10, 5, 2, 3),
    ...
    expect_message(
        quanteda.core:::message_select("remove", 1, 5, 0, 1),
        ", padded"
    )
    expect_message(
        quanteda.core:::message_select("remove", 1, 5, 0, 1),
    ...
    expect_message(
        quanteda.core:::message_select("remove", 5, 1, 1, 0),
        "1 feature"
    )
})
...
test_that("pattern2list is working with a list", {
    ...
    ids <- quanteda.core:::pattern2list(phrase(pat), type, 'fixed', FALSE)
...
test_that("pattern2list is working with a dictionary", {
    ...
    ids <- quanteda.core:::pattern2list(dict, type, "glob", FALSE)
...
test_that("pattern2list is working with empty patterns", {
    ...
    pat <- list()
    expect_silent(quanteda.core:::pattern2list(col, types(toks), "fixed", TRUE))
...
test_that("sample_bygroup works with sizes", {
    ...
    tmp <- quanteda.core:::sample_bygroup(1:10, group = grvec, size = 2, replace = TRUE)
    ...
    tmp <- quanteda.core:::sample_bygroup(1:10, group = grvec, size = c(1, 1, 3), replace = TRUE)
    ...
    tmp <- quanteda.core:::sample_bygroup(1:10, group = grvec, replace = TRUE)
    ...
    tmp <- quanteda.core:::sample_bygroup(c(1:2, c(101:102)), 
    ...
    expect_error(
        quanteda.core:::sample_bygroup(1:10, group = grvec[1:6], size = c(2, 3), replace = TRUE),
        "group not equal in length of x"
    )
    expect_error(
        quanteda.core:::sample_bygroup(1:10, group = grvec, size = c(2, 3), replace = TRUE),
...
test_that("sample_bygroup works with groups of size 1", {
    ...
    for (i in seq_len(10)) {
        tmp <- quanteda.core:::sample_bygroup(1:4, group = grvec, replace = TRUE)
...
test_that("max_load_factor can be configured", {
    quanteda.core:::qatd_cpp_set_load_factor("pattern", 0.2)
    quanteda.core:::qatd_cpp_set_load_factor("pattern", -1.0)
    quanteda.core:::qatd_cpp_set_load_factor("pattern", 2.0)
    quanteda.core:::qatd_cpp_set_load_factor("ngrams", 0.7)
    quanteda.core:::qatd_cpp_set_load_factor("ngrams", -1.0)
    quanteda.core:::qatd_cpp_set_load_factor("ngrams", 2.0)
    expect_equal(quanteda.core:::qatd_cpp_get_load_factor(),
