...
test_that("test that ordered argument is working", {
    ...
    expect_equal(rownames(seqs)[1:4],
    ...
    expect_equal(rownames(seqs_ordered)[1:4],
...
test_that("test that nested arguement is working", {
    ...
    expect_equal(rownames(seqs), c('G G', 'E E', 'E E G G'))
    ...
    expect_equal(rownames(seqs_nested), c('G G', 'E E G G', 'E E', 'E G G'))
