...
test_that("textstat_summary chaching is working", {
    ...
    expect_equal(nrow(textstat_summary(head(corp, 10), cache = TRUE)), 10)
    ...
    expect_equal(nrow(textstat_summary(head(toks, 10), cache = TRUE)), 10)
    ...
    expect_equal(nrow(textstat_summary(head(dfmt, 10), cache = TRUE)), 10)
})
